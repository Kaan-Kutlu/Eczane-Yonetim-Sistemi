 ...
 * @author Hemaa
 */
public class Geri_Iade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Geri İade İlaçları");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(drug_name, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 339));
   ...
   if(barcode.getText().equals("") || drug_name.getText().equals("")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Geri_Iade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
