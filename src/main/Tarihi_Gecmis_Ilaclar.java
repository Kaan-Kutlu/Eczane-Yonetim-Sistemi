...
public class Tarihi_Gecmis_Ilaclar extends javax.swing.JFrame {
Connection con = null;
PreparedStatement pre= null;
ResultSet res = null;
    
    public Tarihi_Gecmis_Ilaclar() {
        initComponents();
        con=Connect.connect();
        show_table();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tarihi Geçmiş İlaçlar");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 476));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tarihi_Gecmis_Ilaclar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
