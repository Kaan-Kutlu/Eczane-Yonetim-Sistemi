 ...
 * @author Hemaa
 */
public class Ilac_Sirket extends javax.swing.JFrame {
Connection con = null;
...
ResultSet res = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("İlaç_Şirket_Formu");
        ...
        jLabel5.setText("Not : İşlem Yapmak İstediğiniz Şirket Bilgilerinizi Kaydetmelisiniz");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 852, 413));
  ...
  try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ilac_Sirket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ilac_Sirket().setVisible(true);
            }
        });
    }
