 ...
 * @author Hemaa
 */
public class Ilac_Ara extends javax.swing.JFrame {
Connection con = null;
...
ResultSet res = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("İlaç Arama Formu");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 541));
...
try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ilac_Ara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
