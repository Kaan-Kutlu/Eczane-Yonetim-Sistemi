 ...
 * @author Hemaa
 */
public class Sifre_Degistirme extends javax.swing.JFrame {
Connection con = null;
...
ResultSet res= null;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Şifre_Değiştirme_Formu");
        ...
        jLabel3.setText("Yeni_Şifre : ");

        jLabel1.setForeground(new java.awt.Color(102, 255, 51));
        jLabel1.setText("Kullanıcı_Id : ");

        jLabel4.setForeground(new java.awt.Color(102, 255, 0));
        jLabel4.setText("Yeni_Şifre_Onaylama : ");

        id.setEditable(false);

        jLabel2.setForeground(new java.awt.Color(102, 255, 51));
        jLabel2.setText("Eski_Şifre : ");

        confirmed.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        confirmed.setForeground(new java.awt.Color(255, 0, 0));
        confirmed.setText("Onaylandı");

        we_st.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        we_st.setForeground(new java.awt.Color(102, 255, 0));
        we_st.setText("Zayıf Şifre");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(confirmed, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE))))
        );
        ...
        jButton1.setText("Şifreyi_Güncelle");
        ...
        jPanel3.getAccessibleContext().setAccessibleName("Şifreni_Değiştir");

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 387));
...
JOptionPane.showMessageDialog(null,"Complete Your Inforamtion","Missing Information",2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sifre_Degistirme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
