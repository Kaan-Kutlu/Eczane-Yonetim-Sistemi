 ...
 * @author Hemaa
 */
public class Fiyat_Düzenle extends javax.swing.JFrame {
Connection con = null;
PreparedStatement pre = null;
ResultSet res= null;

    public Fiyat_Düzenle() {
        initComponents();
        con=Connect.connect();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fiyat Düzenleme Formu");
...
if(barcode.getText().equals("")&&old_price.getText().equals("")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fiyat_Düzenle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
