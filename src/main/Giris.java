...
static String NAME;
    public Giris() {
    	setIconImage(Toolkit.getDefaultToolkit().getImage(Giris.class.getResource("/img/Untitled.png")));
        initComponents();
        con=Connect.connect();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Giriş Formu");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(247, 19, -1, -1));
        ...
        jLabel5.setText("Not : Şifre en az 6 karakterden oluşmalı");
        ...
        jPanel3.getAccessibleContext().setAccessibleName("Giriş Bilgileri");
...
private void login_Hold(){
     ...
     pass.setText("Şifre Giriniz : ");
     pass.setForeground(Color.GRAY);
     id.setText("ID No Giriniz : ");
