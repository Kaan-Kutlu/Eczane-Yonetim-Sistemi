 ...
 * @author Hemaa
 */
public class Gonder extends javax.swing.JFrame {
Connection con = null;
...
static String message_To;
    public Gonder() {
        ...
        con=Connect.connect();
        fill_username();
        message_from.setText(Eczane.username1.getText());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mesaj Gönderme Formu");
        ...
        message_to.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kullanıcı Adı :" }));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 509, 409));
...
new Gelen_Kutusu().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gonder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
